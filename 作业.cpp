...
int main(){
 ...
 string choice_cin, answer_cin;
    ...
    while (1)
    {
        ...
        if ((key[0]==key[1])||(key[0]==key[2])||(key[2]==key[1])) continue; //make sure the three numbers are different
            ...
            for (counter = 0;counter < 7; ++counter)
            {
                ...
                while (1)
                {
                    ...
                    if ((answer_cin.size()==3)&&(answer1 >= '0')&&(answer1 <= '9')&&
                        (answer2 >= '0')&&(answer2 <= '9')&&(answer3 >= '0')&&(answer3 <= '9')) //make sure the input can only be three numbers
                        break;
                }
